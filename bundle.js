...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(SaveButton, [{
	    ...
	    value: function render() {
	      ...
	      var saveCard = function saveCard() {
	        ...
	        recipes[_this7.props.index].name = _this7.props.nameState;
	        recipes[_this7.props.index].ingredients = _this7.props.ingredientState;
	        update();
	      };
	      return _react2.default.createElement(
	        'i',
	...
	var EditCard = function (_React$Component11) {
	  ...
	  function EditCard(props, context) {
	    ...
	    var _this17 = _possibleConstructorReturn(this, Object.getPrototypeOf(EditCard).call(this, props, context));

	    _this17.handleNameChange = _this17.handleNameChange.bind(_this17);
	    _this17.handleIngredientChange = _this17.handleIngredientChange.bind(_this17);

	    _this17.state = {
	      nameValue: _this17.props.name,
	      ingredientValue: _this17.props.ingredients.join(", ")
	    };
	  ...
	  _createClass(EditCard, [{
	    ...
	    value: function handleIngredientChange() {
	      this.setState({
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { className: 'recipeName recipeNameEdit', type: 'text', id: 'nameEdit', defaultValue: this.state.nameValue, onChange: this.handleNameChange })
	        ),
	        _react2.default.createElement(
	          'p',
	        ...
	        _react2.default.createElement('textarea', { className: 'ingredientListEdit', id: 'ingredientsEdit', defaultValue: this.state.ingredientValue, onChange: this.handleIngredientChange }),
	        _react2.default.createElement(SaveButton, { index: this.props.index, nameState: this.state.nameValue, ingredientState: this.state.ingredientValue.split(", ") }),
	        _react2.default.createElement(DeleteButton, { index: this.props.index })
	      );
	    }
	  }]);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.list.map(function (item) {
	            return _react2.default.createElement(Ingredient, { item: item, key: _this19.props.list.indexOf(item) });
	          })
	        )
	      );
	    }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: '//github.com/fractal-mind/recipe-box', id: 'attribution' },
